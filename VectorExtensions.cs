...
namespace BFL
{
    public static class VectorExtensions
    {
        ...
        /// <summary>
        ///     Rounds Vector3 to the nearest half.
        /// </summary>
        /// <param name="vector3"></param>
        /// <returns>Rounded Vector3</returns>
        public static Vector3 RoundToNearestHalf(this Vector3 vector3)
        {
            return new Vector3(vector3.x.RoundToNearestHalf(), vector3.y.RoundToNearestHalf(), vector3.z.RoundToNearestHalf());
        }
